...
public class b4xloadingindicator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ir.taravatgroup.aminkala.b4xloadingindicator");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", ir.taravatgroup.aminkala.b4xloadingindicator.class).invoke(this, new Object[] {null});
        else
...
public ir.taravatgroup.aminkala.main _main = null;
...
_cvs.Resize((float) (_width),(float) (_height));
 //BA.debugLineNum = 38;BA.debugLine="MainLoop";
_mainloop();
...
_mbase.setTag(this);
 //BA.debugLineNum = 28;BA.debugLine="clr = xui.PaintOrColorToColor(Props.Get(\"Color\"";
_clr = _xui.PaintOrColorToColor(_props.Get((Object)("Color")));
 //BA.debugLineNum = 29;BA.debugLine="Dim style As String= Props.Get(\"IndicatorStyle\")";
_style = BA.ObjectToString(_props.Get((Object)("IndicatorStyle")));
 //BA.debugLineNum = 30;BA.debugLine="Dim duration As Int = Props.Get(\"Duration\")";
_duration = (int)(BA.ObjectToNumber(_props.Get((Object)("Duration"))));
 //BA.debugLineNum = 31;BA.debugLine="DrawingSubName = \"Draw_\" & style.Replace(\" \", \"\")";
_drawingsubname = "Draw_"+_style.replace(" ","");
 //BA.debugLineNum = 32;BA.debugLine="cvs.Initialize(mBase)";
_cvs.Initialize(_mbase);
 //BA.debugLineNum = 33;BA.debugLine="MainLoop";
_mainloop();
...
float _r = 0f;
 //BA.debugLineNum = 103;BA.debugLine="Private Sub Draw_Arc1 (Progress As Float)";
 //BA.debugLineNum = 104;BA.debugLine="Dim p As B4XPath";
_p = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
 //BA.debugLineNum = 105;BA.debugLine="Dim r As Float = cvs.TargetRect.CenterX - 5dip";
_r = (float) (_cvs.getTargetRect().getCenterX()-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 106;BA.debugLine="If Progress < 0.5 Then";
if (_progress<0.5) { 
 //BA.debugLineNum = 107;BA.debugLine="p.InitializeArc(cvs.TargetRect.CenterX, cvs.Targ";
...
_p.InitializeArc(_cvs.getTargetRect().getCenterX(),_cvs.getTargetRect().getCenterY(),_r,(float) (-90),(float) (-(1-_progress)*2*360));
 ...
 //BA.debugLineNum = 111;BA.debugLine="cvs.ClipPath(p)";
_cvs.ClipPath(_p);
 //BA.debugLineNum = 112;BA.debugLine="cvs.DrawRect(cvs.TargetRect, clr, True, 0)";
_cvs.DrawRect(_cvs.getTargetRect(),_clr,__c.True,(float) (0));
 //BA.debugLineNum = 113;BA.debugLine="cvs.RemoveClip";
_cvs.RemoveClip();
...
anywheresoftware.b4a.objects.B4XCanvas.B4XPath _p = null;
float _r = 0f;
 //BA.debugLineNum = 116;BA.debugLine="Private Sub Draw_Arc2 (Progress As Float)";
 //BA.debugLineNum = 117;BA.debugLine="Dim p As B4XPath";
_p = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
 //BA.debugLineNum = 118;BA.debugLine="Dim r As Float = cvs.TargetRect.CenterX - 5dip";
_r = (float) (_cvs.getTargetRect().getCenterX()-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 119;BA.debugLine="If Progress < 0.5 Then";
if (_progress<0.5) { 
 //BA.debugLineNum = 120;BA.debugLine="p.InitializeArc(cvs.TargetRect.CenterX, cvs.Targ";
_p.InitializeArc(_cvs.getTargetRect().getCenterX(),_cvs.getTargetRect().getCenterY(),_r,(float) (-90),(float) (_progress*2*360));
 }else {
...
_p.InitializeArc(_cvs.getTargetRect().getCenterX(),_cvs.getTargetRect().getCenterY(),_r,(float) (-90),(float) (360-(_progress-0.5)*2*360));
 ...
 //BA.debugLineNum = 124;BA.debugLine="cvs.ClipPath(p)";
_cvs.ClipPath(_p);
 //BA.debugLineNum = 125;BA.debugLine="cvs.DrawRect(cvs.TargetRect, clr, True, 0)";
_cvs.DrawRect(_cvs.getTargetRect(),_clr,__c.True,(float) (0));
 //BA.debugLineNum = 126;BA.debugLine="cvs.RemoveClip";
_cvs.RemoveClip();
...
int _i = 0;
float _r = 0f;
 //BA.debugLineNum = 93;BA.debugLine="Private Sub Draw_FiveLines1(Progress As Float)";
 //BA.debugLineNum = 94;BA.debugLine="Dim MinR As Int = 10dip";
_minr = __c.DipToCurrent((int) (10));
 //BA.debugLineNum = 95;BA.debugLine="Dim MaxR As Int = cvs.TargetRect.Height / 2";
_maxr = (int) (_cvs.getTargetRect().getHeight()/(double)2);
 //BA.debugLineNum = 96;BA.debugLine="Dim dx As Int = (cvs.TargetRect.Width - 2dip) / 5";
_dx = (int) ((_cvs.getTargetRect().getWidth()-__c.DipToCurrent((int) (2)))/(double)5);
 //BA.debugLineNum = 97;BA.debugLine="For i = 0 To 4";
{
final int step4 = 1;
final int limit4 = (int) (4);
_i = (int) (0) ;
for (;_i <= limit4 ;_i = _i + step4 ) {
 //BA.debugLineNum = 98;BA.debugLine="Dim r As Float = MinR + MaxR / 2 + MaxR / 2 * Si";
_r = (float) (_minr+_maxr/(double)2+_maxr/(double)2*__c.SinD(_progress*360-30*_i));
 //BA.debugLineNum = 99;BA.debugLine="cvs.DrawLine(2dip + i * dx, cvs.TargetRect.Cente";
...
int _cy = 0;
int _r = 0;
 //BA.debugLineNum = 129;BA.debugLine="Private Sub Draw_PacMan(Progress As Float)";
 //BA.debugLineNum = 130;BA.debugLine="Dim DotR As Int = 5dip";
_dotr = __c.DipToCurrent((int) (5));
 //BA.debugLineNum = 131;BA.debugLine="cvs.DrawCircle(cvs.TargetRect.Width - DotR - Prog";
_cvs.DrawCircle((float) (_cvs.getTargetRect().getWidth()-_dotr-_progress*(_cvs.getTargetRect().getCenterX()-__c.DipToCurrent((int) (10)))),_cvs.getTargetRect().getCenterY(),(float) (_dotr),_setalpha(_clr,(int) (255-200*_progress)),__c.True,(float) (0));
 //BA.debugLineNum = 132;BA.debugLine="Dim p As B4XPath";
_p = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
 //BA.debugLineNum = 133;BA.debugLine="Dim angle As Int = 70 * SinD(Progress * 180)";
_angle = (int) (70*__c.SinD(_progress*180));
 //BA.debugLineNum = 134;BA.debugLine="Dim cx As Int = cvs.TargetRect.CenterX - 5dip";
_cx = (int) (_cvs.getTargetRect().getCenterX()-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 135;BA.debugLine="Dim cy As Int = cvs.TargetRect.CenterY";
_cy = (int) (_cvs.getTargetRect().getCenterY());
 //BA.debugLineNum = 136;BA.debugLine="Dim r As Int = cvs.TargetRect.CenterY - 5dip";
_r = (int) (_cvs.getTargetRect().getCenterY()-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 137;BA.debugLine="If angle = 0 Then";
if (_angle==0) { 
 //BA.debugLineNum = 138;BA.debugLine="cvs.DrawCircle(cx, cy, r, clr, True, 0)";
_cvs.DrawCircle((float) (_cx),(float) (_cy),(float) (_r),_clr,__c.True,(float) (0));
 }else {
 //BA.debugLineNum = 140;BA.debugLine="p.InitializeArc(cx, cy , r, -angle / 2, -(360-an";
_p.InitializeArc((float) (_cx),(float) (_cy),(float) (_r),(float) (-_angle/(double)2),(float) (-(360-_angle)));
 //BA.debugLineNum = 141;BA.debugLine="cvs.ClipPath(p)";
_cvs.ClipPath(_p);
 //BA.debugLineNum = 142;BA.debugLine="cvs.DrawRect(cvs.TargetRect, clr, True, 0)";
_cvs.DrawRect(_cvs.getTargetRect(),_clr,__c.True,(float) (0));
 //BA.debugLineNum = 143;BA.debugLine="cvs.RemoveClip";
_cvs.RemoveClip();
 };
...
int _i = 0;
 //BA.debugLineNum = 83;BA.debugLine="Private Sub Draw_SingleCircle(Progress As Float)";
...
for (;_i <= limit1 ;_i = _i + step1 ) {
 //BA.debugLineNum = 85;BA.debugLine="cvs.DrawCircle(cvs.TargetRect.CenterX, cvs.Targe";
...
int _i = 0;
int _alpha = 0;
 //BA.debugLineNum = 65;BA.debugLine="Private Sub Draw_ThreeCircles1 (Progress As Float)";
 //BA.debugLineNum = 66;BA.debugLine="Dim MaxR As Float = (cvs.TargetRect.Width / 2 - 2";
_maxr = (float) ((_cvs.getTargetRect().getWidth()/(double)2-__c.DipToCurrent((int) (20)))/(double)2);
 //BA.debugLineNum = 67;BA.debugLine="Dim r As Float = 10dip + MaxR + MaxR * Sin(Progre";
_r = (float) (__c.DipToCurrent((int) (10))+_maxr+_maxr*__c.Sin(_progress*2*__c.cPI));
 //BA.debugLineNum = 68;BA.debugLine="For i = 0 To 2";
{
final int step3 = 1;
final int limit3 = (int) (2);
_i = (int) (0) ;
for (;_i <= limit3 ;_i = _i + step3 ) {
 //BA.debugLineNum = 69;BA.debugLine="Dim alpha As Int = i * 120 + Progress * 360";
_alpha = (int) (_i*120+_progress*360);
 //BA.debugLineNum = 70;BA.debugLine="cvs.DrawCircle(cvs.TargetRect.CenterX + r * SinD";
...
int _i = 0;
float _r = 0f;
 //BA.debugLineNum = 74;BA.debugLine="Private Sub Draw_ThreeCircles2 (Progress As Float)";
 //BA.debugLineNum = 75;BA.debugLine="Dim MinR As Int = 5dip";
_minr = __c.DipToCurrent((int) (5));
 //BA.debugLineNum = 76;BA.debugLine="Dim MaxR As Int = cvs.TargetRect.Width / 2 / 3 -";
_maxr = (int) (_cvs.getTargetRect().getWidth()/(double)2/(double)3-_minr-__c.DipToCurrent((int) (2)));
 //BA.debugLineNum = 77;BA.debugLine="For i = 0 To 2";
{
final int step3 = 1;
final int limit3 = (int) (2);
_i = (int) (0) ;
for (;_i <= limit3 ;_i = _i + step3 ) {
 //BA.debugLineNum = 78;BA.debugLine="Dim r As Float = MinR + MaxR / 2 + MaxR / 2 * Si";
_r = (float) (_minr+_maxr/(double)2+_maxr/(double)2*__c.SinD(_progress*360-60*_i));
 //BA.debugLineNum = 79;BA.debugLine="cvs.DrawCircle(MaxR + MinR + (MinR + MaxR + 2dip";
...
public String  _hide() throws Exception{
 //BA.debugLineNum = 60;BA.debugLine="Public Sub Hide";
 //BA.debugLineNum = 61;BA.debugLine="mBase.Visible = False";
_mbase.setVisible(__c.False);
 //BA.debugLineNum = 62;BA.debugLine="index = index + 1";
_index = (int) (_index+1);
...
public ResumableSub_MainLoop(ir.taravatgroup.aminkala.b4xloadingindicator parent) {
this.parent = parent;
}
ir.taravatgroup.aminkala.b4xloadingindicator parent;
int _myindex = 0;
long _n = 0L;
float _progress = 0f;
...
parent._index = (int) (parent._index+1);
 //BA.debugLineNum = 43;BA.debugLine="Dim MyIndex As Int = index";
_myindex = parent._index;
 //BA.debugLineNum = 44;BA.debugLine="Dim n As Long = DateTime.Now";
_n = parent.__c.DateTime.getNow();
 //BA.debugLineNum = 45;BA.debugLine="Do While MyIndex = index";
if (true) break;
...
//C
this.state = 1;
 //BA.debugLineNum = 46;BA.debugLine="Dim progress As Float = (DateTime.Now - n) / dur";
_progress = (float) ((parent.__c.DateTime.getNow()-_n)/(double)parent._duration);
 //BA.debugLineNum = 47;BA.debugLine="progress = progress - Floor(progress)";
_progress = (float) (_progress-parent.__c.Floor(_progress));
 //BA.debugLineNum = 48;BA.debugLine="cvs.ClearRect(cvs.TargetRect)";
parent._cvs.ClearRect(parent._cvs.getTargetRect());
 //BA.debugLineNum = 49;BA.debugLine="CallSub2(Me, DrawingSubName, progress)";
parent.__c.CallSubNew2(ba,parent,parent._drawingsubname,(Object)(_progress));
 //BA.debugLineNum = 50;BA.debugLine="cvs.Invalidate";
parent._cvs.Invalidate();
 //BA.debugLineNum = 51;BA.debugLine="Sleep(10)";
...
public int  _setalpha(int _c,int _alpha) throws Exception{
 //BA.debugLineNum = 89;BA.debugLine="Private Sub SetAlpha (c As Int, alpha As Int) As I";
 //BA.debugLineNum = 90;BA.debugLine="Return Bit.And(0xffffff, c) + Bit.ShiftLeft(alpha";
if (true) return (int) (__c.Bit.And(((int)0xffffff),_c)+__c.Bit.ShiftLeft(_alpha,(int) (24)));
 //BA.debugLineNum = 91;BA.debugLine="End Sub";
return 0;
}
public String  _show() throws Exception{
 //BA.debugLineNum = 55;BA.debugLine="Public Sub Show";
 //BA.debugLineNum = 56;BA.debugLine="mBase.Visible = True";
_mbase.setVisible(__c.True);
 //BA.debugLineNum = 57;BA.debugLine="MainLoop";
_mainloop();
